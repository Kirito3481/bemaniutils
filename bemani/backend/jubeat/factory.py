...
from bemani.backend.jubeat.beyondtheavenue import JubeatBeyondTheAvenue
...
class JubeatFactory(Factory):
    ...
    def create(
        ...
        if model.gamecode == "L44":
            ...
            if model.version >= 2022080300 and model.version < 2023092000:
                return JubeatAvenue(data, config, model)
            if model.version >= 2023092000:
                return JubeatBeyondTheAvenue(data, config, model)
